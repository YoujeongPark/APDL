...
year = 2018
file_name = str(year) + '_x_data.csv'
...
if __name__ == "__main__":
    ...
    if (is_local):
        ...
        PATH = "../01_Velocity_Data_m_s/Velocity_" + str(year) + "/"
    ...
    data_output.to_csv(file_name, index=False)
    ...
    # scaled_data_output.to_csv(, index=False)
